...
<div class="main-container">
  ...
  <div class="column2">
    <div class="content left">
      <p class="margin20">You have selected a <strong><?php echo $orderInfo; ?> for $<?php echo $amount; ?></strong>. If this is not correct, <a href="register.html">click here to go back and choose again</a>.</p>

...
<title>Flight Risk Aerials | Reserve Your Spot Online</title>
...
if (strpos($_SERVER['HTTP_USER_AGENT'], 'Safari') && !strpos($_SERVER['HTTP_USER_AGENT'], 'Chrome')) {
    if (count($_COOKIE) === 0) {
     echo '<script> 
     top.location = "https://my.slateit.com/setcookie.php?url="+window.location.href;
     </script>';
    }
}
?>
...
<div class="main-container" style="width:100%">
  <h1><a href="index.html" class="green-link">Flight Risk Aerials</a> Reserve Your Spot Online!</h1>
  <p style="padding:5px"><a href="https://my.slateit.com/student-login.php?studioID=1">If you are having trouble using this page, click here and try again!</a> Please report any difficulties to Kim at <a href="mailto:kim@wellnessonthegreen.com">kim@wellnessonthegreen.com</a> or via text at 862-823-2778!</p>
  <p>&nbsp;</p>
  <iframe src="https://my.slateit.com/student-login.php?studioID=1" frameborder="0" style="overflow: hidden; height: 100%; width: 100%; position: absolute;" height="100%" width="100%"></iframe>
</div>
<!-- main-content -->
